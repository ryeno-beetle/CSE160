class Model {
    ...
    async parseModel(fileContent) {
        ...
        this.modelData = {
            ...
            uvCoords: new Float32Array(unpackedVerts.slice(0, 2 * (unpackedVerts.length / 3)))
        };
    ...
    render() {
        ...
        gl.bufferData(gl.ARRAY_BUFFER, this.modelData.uvCoords, gl.DYNAMIC_DRAW);
